...
export default function Timetable() {
  ...
  const timetableData = {
    friday: [
      { artist: 'Guiding Youth', stage: 'Wooden Roots Floor', time: '14:00 – 20:00', color: '#E6392F', playingAgainst: 'Creativ Dubs' },
      { artist: 'Creativ Dubs', stage: 'Wooden Roots Floor', time: '14:00 – 20:00', color: '#E6392F', playingAgainst: 'Guiding Youth' },
      { artist: 'Dreadical Warriors', stage: "Steppin' Grass Field", time: '16:00 – 22:00', color: '#138A5A' },
      { artist: 'Henna Workshop', stage: 'Irie Knowledge Hut', time: '15:00 – 17:00', color: '#F7C600' },
    ],
    saturday: [
      { artist: 'Ital Brew', stage: 'Wooden Roots Floor', time: '12:00 – 18:00', color: '#E6392F', playingAgainst: 'Little Man' },
      { artist: 'Little Man', stage: 'Wooden Roots Floor', time: '12:00 – 18:00', color: '#E6392F', playingAgainst: 'Ital Brew' },
      { artist: 'Steppin\' Ground', stage: "Steppin' Grass Field", time: '14:00 – 20:00', color: '#138A5A' },
      { artist: 'Jahmateur Hi Power', stage: "Steppin' Grass Field", time: '20:00 – 02:00', color: '#138A5A' },
      { artist: 'Yoga Flow', stage: 'Irie Knowledge Hut', time: '10:00 – 11:30', color: '#F7C600' },
      { artist: 'Ecstatic Dance', stage: 'Irie Knowledge Hut', time: '16:00 – 18:00', color: '#F7C600' },
    ],
    sunday: [
      { artist: 'Unification', stage: 'Wooden Roots Floor', time: '11:00 – 17:00', color: '#E6392F' },
      { artist: 'Crucial', stage: 'Wooden Roots Floor', time: '17:00 – 22:00', color: '#E6392F' },
      { artist: 'Tune', stage: "Steppin' Grass Field", time: '13:00 – 19:00', color: '#138A5A' },
      { artist: 'Meditation', stage: 'Irie Knowledge Hut', time: '09:00 – 10:00', color: '#F7C600' },
      { artist: 'Fire Dance', stage: 'Irie Knowledge Hut', time: '20:00 – 21:00', color: '#F7C600' },
    ],
  };
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-8">
          <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full border-2 border-black">
            ...
            <span className="font-['Poppins'] text-sm font-medium">Wooden Roots Floor</span>
          </div>
          <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full border-2 border-black">
            <div className="w-4 h-4 rounded-full bg-[#138A5A] border-2 border-black"></div>
            <span className="font-['Poppins'] text-sm font-medium">Steppin' Grass Field</span>
          </div>
          <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full border-2 border-black">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {timetableData[activeDay].map((event, index) => (
            ...
            >
              ...
              {/* Artist Name */}
              <h3 className="font-['Fredoka'] text-xl font-bold mb-2" style={{ color: event.color }}>
                {event.artist}
              </h3>
            ...
            {selectedArtist && (
              <div className="space-y-4">
                <div className="bg-[#FFF3D6] rounded-2xl border-2 border-black p-4">
                  <div className="mb-3">
                    <h4 className="font-['Fredoka'] font-bold text-sm text-gray-600 mb-1">Stage</h4>
                    <p className="font-['Poppins'] text-base">{selectedArtist.stage}</p>
                  </div>
                  
                  <div className="mb-3">
                    <h4 className="font-['Fredoka'] font-bold text-sm text-gray-600 mb-1">Time</h4>
                    <p className="font-['Poppins'] text-base">{selectedArtist.time}</p>
                  </div>

                  {selectedArtist.playingAgainst && (
                    <div>
                      <h4 className="font-['Fredoka'] font-bold text-sm text-gray-600 mb-1">Playing Against</h4>
      ...
      <div className="max-w-6xl mx-auto px-4 mt-20">
        <div className="text-center mb-12">
          ...
          <p className="font-['Poppins'] text-lg text-gray-700 max-w-2xl mx-auto">
            Living Dub organizes regular events throughout the year. Join us for monthly soundsystem sessions, workshops, and community gatherings.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <h3 className="font-['Fredoka'] text-2xl mb-2">Soundsystem Session</h3>
            <p className="font-['Poppins'] text-sm text-gray-600 mb-3">
              First Saturday of every month
            </p>
            <p className="font-['Poppins'] text-sm mb-4">
              Monthly soundsystem showcase featuring local and international selectors. Deep dub, roots reggae, and conscious vibrations.
            </p>
            <div className="flex items-center gap-2 text-sm">
              <div className="w-3 h-3 rounded-full bg-[#E6392F]"></div>
              <span className="font-['Poppins'] font-medium">21:00 - 04:00</span>
            </div>
          </div>
          ...
          >
            ...
            <h3 className="font-['Fredoka'] text-2xl mb-2">Yoga & Meditation</h3>
            <p className="font-['Poppins'] text-sm text-gray-600 mb-3">
              Every Sunday morning
            </p>
            <p className="font-['Poppins'] text-sm mb-4">
              Start your week centered. Community yoga and meditation sessions in nature. All levels welcome.
            </p>
            <div className="flex items-center gap-2 text-sm">
              <div className="w-3 h-3 rounded-full bg-[#138A5A]"></div>
              <span className="font-['Poppins'] font-medium">10:00 - 11:30</span>
            </div>
          </div>
          ...
          >
            ...
            <h3 className="font-['Fredoka'] text-2xl mb-2">Vinyl Selection Night</h3>
            <p className="font-['Poppins'] text-sm text-gray-600 mb-3">
              Every other Friday
            </p>
            <p className="font-['Poppins'] text-sm mb-4">
              Intimate vinyl listening sessions. Bring your records, share the vibes, connect through music culture.
            </p>
            <div className="flex items-center gap-2 text-sm">
              <div className="w-3 h-3 rounded-full bg-[#F7C600]"></div>
              <span className="font-['Poppins'] font-medium">19:00 - 23:00</span>
            </div>
          </div>
          ...
          >
            ...
            <h3 className="font-['Fredoka'] text-2xl mb-2">Creative Workshop Series</h3>
            <p className="font-['Poppins'] text-sm text-gray-600 mb-3">
              Third Sunday of every month
            </p>
            <p className="font-['Poppins'] text-sm mb-4">
              Rotating workshops: graffiti, henna, natural dyeing, instrument making, and more creative community activities.
            </p>
            <div className="flex items-center gap-2 text-sm">
              <div className="w-3 h-3 rounded-full bg-[#E6392F]"></div>
              <span className="font-['Poppins'] font-medium">14:00 - 17:00</span>
            </div>
          </div>
          ...
          >
            ...
            <h3 className="font-['Fredoka'] text-2xl mb-2">Community Gathering</h3>
            <p className="font-['Poppins'] text-sm text-gray-600 mb-3">
              Last Wednesday of every month
            </p>
            <p className="font-['Poppins'] text-sm mb-4">
              Open community meeting to share ideas, plan events, and build connections. Potluck dinner included.
            </p>
            <div className="flex items-center gap-2 text-sm">
              <div className="w-3 h-3 rounded-full bg-[#138A5A]"></div>
              <span className="font-['Poppins'] font-medium">18:00 - 21:00</span>
            </div>
          </div>
          ...
          >
            ...
            <h3 className="font-['Fredoka'] text-2xl mb-2">Seasonal Celebration</h3>
            <p className="font-['Poppins'] text-sm text-gray-600 mb-3">
              Every solstice & equinox
            </p>
            <p className="font-['Poppins'] text-sm mb-4">
              Celebrate the turning of the seasons with music, food, fire, and community. Connect with natural rhythms.
            </p>
            <div className="flex items-center gap-2 text-sm">
              <div className="w-3 h-3 rounded-full bg-[#F7C600]"></div>
              <span className="font-['Poppins'] font-medium">16:00 - 23:00</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          >
            <p className="font-['Poppins'] text-white text-lg mb-4 max-w-2xl">
              Want to stay updated on all our regular events? Follow us on social media or join our mailing list!
            </p>
